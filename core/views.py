# Adding match notification sending to like_user view and incorporating necessary imports.
            ...
            if mutual_like:
                ...
                async_to_sync(channel_layer.group_send)(
                    f'user_{request.user.id}',
                    {
                        ...
                        'notification': {
                            'type': 'match',
                            'message': f"It's a match! You and {to_user.profile.name} liked each other",
                            'data': {
                                'match_id': match.id,
                                'other_user': {
                                    'id': to_user.id,
                                    'name': to_user.profile.name,
                                    'photos': to_user.profile.get_photos()
                                }
                            }
                        }
                    }
                ...
                async_to_sync(channel_layer.group_send)(
                    f'user_{to_user.id}',
                    {
                        ...
                        'notification': {
                            'type': 'match',
                            'message': f"It's a match! You and {request.user.profile.name} liked each other",
                            'data': {
                                'match_id': match.id,
                                'other_user': {
                                    'id': request.user.id,
                                    'name': request.user.profile.name,
                                    'photos': request.user.profile.get_photos()
                                }
                            }
                        }
                    }
